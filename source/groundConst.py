...
class LevelOne(Enum):
    ...
    ground7 = [[], [(400, -1, 400)], [(1, 100, 250), (1, 325, 475), (1, 550, 700)]]
    ground6 = [[(100, h, ), (200, h), (300, h), (400, h), (500, h)], \
               [(75, 2, y0), (150, 2, y0), (225, 2, y0), (375, 2, y0), (425, 2, y0), (525, 2, y0)], []]
#(1, 200, 300), (1, 500, 550), (1, 600, 700)]
    ground3 = [ [(100, h), (225, h), (325, h), (425, h), (525, h), (625, h), (725, h)], [(150, 1, y0), (300, 1, y1), (500, 1, y0),\
                (700, 1, y1)], [(1, 150, 300), (1, 350, 500), (1, 550, 700)] ]
    ...
    ground2 = [[], [(100, 1, 400), (125, 1, 320), (150, 1, 240), (175, 1, 160), (200, 1, 80), (225, 1, y0), (250, 1, 80), (275, 1, 160), (300, 1, 240),\
               (325, 1, 320), (350, 1, 400) ], [(1, 100, 800)]]
    g = [ground0, ground1, ground2, ground3, ground4, ground5, ground6, ground7]
